...
module  FPSUB2_altbarrel_shift_h0e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //FPSUB2_altbarrel_shift_h0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altbarrel_shift_n3g
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //FPSUB2_altbarrel_shift_n3g
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //FPSUB2_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //FPSUB2_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	FPSUB2_altpriority_encoder_3v7   altpriority_encoder16
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder16_q));
	FPSUB2_altpriority_encoder_3e8   altpriority_encoder17
	( 
	.data(data[3:2]),
...
endmodule //FPSUB2_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	FPSUB2_altpriority_encoder_3e8   altpriority_encoder18
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder18_q),
	.zero(wire_altpriority_encoder18_zero));
	FPSUB2_altpriority_encoder_3e8   altpriority_encoder19
	( 
	.data(data[3:2]),
...
endmodule //FPSUB2_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_eu8
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	FPSUB2_altpriority_encoder_6v7   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q));
	FPSUB2_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
endmodule //FPSUB2_altpriority_encoder_eu8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_ed9
	( 
	data,
	q,
	zero) ;
	...
	FPSUB2_altpriority_encoder_6e8   altpriority_encoder20
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder20_q),
	.zero(wire_altpriority_encoder20_zero));
	FPSUB2_altpriority_encoder_6e8   altpriority_encoder21
	( 
	.data(data[7:4]),
...
endmodule //FPSUB2_altpriority_encoder_ed9

//synthesis_resources = reg 4 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_pja
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	FPSUB2_altpriority_encoder_eu8   altpriority_encoder12
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder12_q));
	FPSUB2_altpriority_encoder_ed9   altpriority_encoder13
	( 
	.data(data[15:8]),
	...
	assign
		q = pipeline_q_dffe,
		tmp_q_wire = {(~ wire_altpriority_encoder13_zero), (({3{wire_altpriority_encoder13_zero}} & wire_altpriority_encoder12_q) | ({3{(~ wire_altpriority_encoder13_zero)}} & wire_altpriority_encoder13_q))};
endmodule //FPSUB2_altpriority_encoder_pja
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_p2b
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	FPSUB2_altpriority_encoder_ed9   altpriority_encoder22
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder22_q),
	.zero(wire_altpriority_encoder22_zero));
	FPSUB2_altpriority_encoder_ed9   altpriority_encoder23
	( 
	.data(data[15:8]),
	...
	assign
		q = pipeline_q_dffe,
		tmp_q_wire = {(~ wire_altpriority_encoder23_zero), (({3{wire_altpriority_encoder23_zero}} & wire_altpriority_encoder22_q) | ({3{(~ wire_altpriority_encoder23_zero)}} & wire_altpriority_encoder23_q))},
		tmp_zero_wire = (wire_altpriority_encoder22_zero & wire_altpriority_encoder23_zero),
		zero = (~ pipeline_zero_n_dffe);
endmodule //FPSUB2_altpriority_encoder_p2b

//synthesis_resources = reg 14 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_pu8
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	FPSUB2_altpriority_encoder_pja   altpriority_encoder10
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	FPSUB2_altpriority_encoder_p2b   altpriority_encoder11
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		q = pipeline_q_dffe,
		tmp_q_wire = {(~ wire_altpriority_encoder11_zero), (({4{wire_altpriority_encoder11_zero}} & wire_altpriority_encoder10_q) | ({4{(~ wire_altpriority_encoder11_zero)}} & wire_altpriority_encoder11_q))};
endmodule //FPSUB2_altpriority_encoder_pu8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_nh8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //FPSUB2_altpriority_encoder_nh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_qh8
	( 
	data,
	q,
	zero) ;
	...
	FPSUB2_altpriority_encoder_nh8   altpriority_encoder30
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder30_q),
	.zero(wire_altpriority_encoder30_zero));
	FPSUB2_altpriority_encoder_nh8   altpriority_encoder31
	( 
	.data(data[3:2]),
...
endmodule //FPSUB2_altpriority_encoder_qh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_vh8
	( 
	data,
	q,
	zero) ;
	...
	FPSUB2_altpriority_encoder_qh8   altpriority_encoder28
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder28_q),
	.zero(wire_altpriority_encoder28_zero));
	FPSUB2_altpriority_encoder_qh8   altpriority_encoder29
	( 
	.data(data[7:4]),
...
endmodule //FPSUB2_altpriority_encoder_vh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_ii9
	( 
	data,
	q,
	zero) ;
	...
	FPSUB2_altpriority_encoder_vh8   altpriority_encoder26
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder26_q),
	.zero(wire_altpriority_encoder26_zero));
	FPSUB2_altpriority_encoder_vh8   altpriority_encoder27
	( 
	.data(data[15:8]),
...
endmodule //FPSUB2_altpriority_encoder_ii9
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_n28
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {(~ data[0])};
endmodule //FPSUB2_altpriority_encoder_n28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_q28
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	FPSUB2_altpriority_encoder_nh8   altpriority_encoder36
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder36_q),
	.zero(wire_altpriority_encoder36_zero));
	FPSUB2_altpriority_encoder_n28   altpriority_encoder37
	( 
	.data(data[3:2]),
...
endmodule //FPSUB2_altpriority_encoder_q28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_v28
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	FPSUB2_altpriority_encoder_qh8   altpriority_encoder34
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder34_q),
	.zero(wire_altpriority_encoder34_zero));
	FPSUB2_altpriority_encoder_q28   altpriority_encoder35
	( 
	.data(data[7:4]),
...
endmodule //FPSUB2_altpriority_encoder_v28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_i39
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	FPSUB2_altpriority_encoder_vh8   altpriority_encoder32
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder32_q),
	.zero(wire_altpriority_encoder32_zero));
	FPSUB2_altpriority_encoder_v28   altpriority_encoder33
	( 
	.data(data[15:8]),
...
endmodule //FPSUB2_altpriority_encoder_i39

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altpriority_encoder_cna
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	FPSUB2_altpriority_encoder_ii9   altpriority_encoder24
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder24_q),
	.zero(wire_altpriority_encoder24_zero));
	FPSUB2_altpriority_encoder_i39   altpriority_encoder25
	( 
	.data(data[31:16]),
	...
	assign
		q = (~ pipeline_q_dffe),
		tmp_q_wire = {wire_altpriority_encoder24_zero, (({4{wire_altpriority_encoder24_zero}} & wire_altpriority_encoder25_q) | ({4{(~ wire_altpriority_encoder24_zero)}} & wire_altpriority_encoder24_q))};
endmodule //FPSUB2_altpriority_encoder_cna

//synthesis_resources = lpm_add_sub 9 lpm_compare 1 reg 701 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPSUB2_altfp_add_sub_avi
	( 
	clock,
	dataa,
	datab,
	...
	reg	infinite_output_sign_dffe26;
	...
	reg	infinity_magnitude_sub_dffe26;
	...
	reg	[25:0]	man_add_sub_res_mag_dffe26;
	reg	man_add_sub_res_sign_dffe21;
	reg	man_add_sub_res_sign_dffe23;
	reg	man_add_sub_res_sign_dffe26;
	reg	[25:0]	man_dffe31;
	...
	FPSUB2_altbarrel_shift_n3g   rbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	FPSUB2_altpriority_encoder_pu8   leading_zeroes_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	FPSUB2_altpriority_encoder_cna   trailing_zeros_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) exp_adj_dffe26 <= 2'b0;
		else if  (clk_en == 1'b1)   exp_adj_dffe26 <= exp_adj_dffe26_wi;
	// synopsys translate_off
	initial
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) exp_res_dffe26 <= 8'b0;
		else if  (clk_en == 1'b1)   exp_res_dffe26 <= exp_res_dffe26_wi;
	// synopsys translate_off
	initial
		exp_res_dffe3 = 0;
	// synopsys translate_on
	...
	// synopsys translate_off
	initial
		infinite_output_sign_dffe26 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) infinite_output_sign_dffe26 <= 1'b0;
		else if  (clk_en == 1'b1)   infinite_output_sign_dffe26 <= infinite_output_sign_dffe26_wi;
	// synopsys translate_off
	initial
	...
	// synopsys translate_off
	initial
		infinity_magnitude_sub_dffe26 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) infinity_magnitude_sub_dffe26 <= 1'b0;
		else if  (clk_en == 1'b1)   infinity_magnitude_sub_dffe26 <= infinity_magnitude_sub_dffe26_wi;
	// synopsys translate_off
	initial
	...
	// synopsys translate_off
	initial
		input_is_infinite_dffe26 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) input_is_infinite_dffe26 <= 1'b0;
		else if  (clk_en == 1'b1)   input_is_infinite_dffe26 <= input_is_infinite_dffe26_wi;
	// synopsys translate_off
	initial
	...
	// synopsys translate_off
	initial
		input_is_nan_dffe26 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) input_is_nan_dffe26 <= 1'b0;
		else if  (clk_en == 1'b1)   input_is_nan_dffe26 <= input_is_nan_dffe26_wi;
	// synopsys translate_off
	initial
	...
	// synopsys translate_off
	initial
		man_add_sub_res_mag_dffe26 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) man_add_sub_res_mag_dffe26 <= 26'b0;
		else if  (clk_en == 1'b1)   man_add_sub_res_mag_dffe26 <= man_add_sub_res_mag_dffe26_wi;
	// synopsys translate_off
	initial
	...
	// synopsys translate_off
	initial
		man_add_sub_res_sign_dffe26 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) man_add_sub_res_sign_dffe26 <= 1'b0;
		else if  (clk_en == 1'b1)   man_add_sub_res_sign_dffe26 <= man_add_sub_res_sign_dffe26_wi;
	// synopsys translate_off
	initial
		man_dffe31 = 0;
	// synopsys translate_on
	...
	// synopsys translate_off
	initial
		man_res_not_zero_dffe26 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) man_res_not_zero_dffe26 <= 1'b0;
		else if  (clk_en == 1'b1)   man_res_not_zero_dffe26 <= man_res_not_zero_dffe26_wi;
	// synopsys translate_off
	initial
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) round_bit_dffe26 <= 1'b0;
		else if  (clk_en == 1'b1)   round_bit_dffe26 <= round_bit_dffe26_wi;
	// synopsys translate_off
	initial
		round_bit_dffe3 = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sticky_bit_dffe26 <= 1'b0;
		else if  (clk_en == 1'b1)   sticky_bit_dffe26 <= sticky_bit_dffe26_wi;
	// synopsys translate_off
	initial
		sticky_bit_dffe3 = 0;
	// synopsys translate_on
	...
	// synopsys translate_off
	initial
		zero_man_sign_dffe26 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) zero_man_sign_dffe26 <= 1'b0;
		else if  (clk_en == 1'b1)   zero_man_sign_dffe26 <= zero_man_sign_dffe26_wi;
...
endmodule //FPSUB2_altfp_add_sub_avi
//VALID FILE
...
module FPSUB2 (
	...
	FPSUB2_altfp_add_sub_avi	FPSUB2_altfp_add_sub_avi_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL FPSUB2.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPSUB2.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPSUB2.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPSUB2.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPSUB2_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPSUB2_bb.v TRUE
